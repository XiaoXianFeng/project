...
<table class="oms_table" border="1" style="margin-left: auto;margin-right: auto; width:80%">
    <tbody>
		...
		<tr>
			...
			<td>
				<a href="#" class="editable" id="wuliao_code" data-type="text" data-pk="wuliao_code" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入物料编码">
					<c:out value="${plan.planItems['wuliao_code'].itemValue}"/>
				</a>
			</td>
		...
		<tr>
			...
			<td colspan="3">
				...
				<label><input id="cat-test" class="ajaxCheckbox-cat" type="checkbox" name="cat-test" ${plan.planItems['cat-test'].itemValue}><span> 测试</span></label>
