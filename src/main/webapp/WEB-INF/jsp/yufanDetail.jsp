...
<table class="oms_table" border="1" style="margin-left: auto;margin-right: auto; width:80%">
    <tbody>
		...
		<tr>
			<td colspan = "11">
				<a href="#" class="editable" id="add_message" data-type="text" data-pk="add_message" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入message">
					<c:out value="${plan.planItems['add_message'].itemValue}"/>
				</a>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan = "2">项目部:</td>
			<td colspan = "6">
				<a href="#" class="editable" id="project_part" data-type="text" data-pk="project_part" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入项目部信息">
					<c:out value="${plan.planItems['project_part'].itemValue}"/>
				</a>
			</td>
			<td colspan = "2">硬件基带,射频:</td>
			<td colspan = "2">
				<a href="#" class="editable" id="rf_name" data-type="text" data-pk="rf_name" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入硬件基带,射频信息">
					<c:out value="${plan.planItems['rf_name'].itemValue}"/>
				</a>
			</td>
		</tr>
		<tr>
			<td colspan = "2">软件部:</td>
			<td colspan = "6">
				<a href="#" class="editable" id="software_part" data-type="text" data-pk="software_part" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入软件部信息">
					<c:out value="${plan.planItems['software_part'].itemValue}"/>
				</a>
			</td>
			<td colspan = "2">软测部:</td>
			<td colspan = "2">
				<a href="#" class="editable" id="softwaretest_part" data-type="text" data-pk="softwaretest_part" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入软测部信息">
					<c:out value="${plan.planItems['softwaretest_part'].itemValue}"/>
				</a>
			</td>
		</tr>
		<tr>
			<td colspan = "2">运营部:</td>
			<td colspan = "6">
				<a href="#" class="editable" id="run_part" data-type="text" data-pk="run_part" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入运营部信息">
					<c:out value="${plan.planItems['run_part'].itemValue}"/>
				</a>
			</td>
			<td colspan = "2">结构部:</td>
			<td colspan = "2">
				<a href="#" class="editable" id="jiegou_part" data-type="text" data-pk="jiegou_part" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入结构部信息">
					<c:out value="${plan.planItems['jiegou_part'].itemValue}"/>
				</a>
			</td>
		</tr>
		<tr>
			<td colspan = "2">销售部:</td>
			<td colspan = "6">
				<a href="#" class="editable" id="sale_part" data-type="text" data-pk="sale_part" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="销售部信息">
					<c:out value="${plan.planItems['sale_part'].itemValue}"/>
				</a>
			</td>
			<td colspan = "2">研发总监:</td>
			<td colspan = "2">
				<a href="#" class="editable" id="yanfa_part" data-type="text" data-pk="yanfa_part" data-url="<%=request.getContextPath()%>/do/plan/save.html" data-title="输入研发总监信息">
					<c:out value="${plan.planItems['yanfa_part'].itemValue}"/>
				</a>
			</td>
		</tr>
	</tbody>
